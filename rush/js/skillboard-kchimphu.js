$(document).ready(function () {
  ...
  function createToolCard(tool) {
    return $(`
      <div class="bg-white rounded-2xl shadow p-6 hover:shadow-lg transition-all">
  ...
  function renderTools() {
    ...
    displayed.forEach((tool) => skillsGrid.append(createToolCard(tool)));
    btn.text(showAll ? "Show Less ▲" : "Show More ▼");
  }
